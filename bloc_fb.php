<div data-remodal-id="fb-messenger">
	<div class="fb-page" data-tabs="messages
		...
		data-width="330" data-height="330" 
		data-href="<?php echo esc_attr( get_option('lmfp_page') ); ?>" 
		data-small-header="true"  data-hide-cover="false" data-show-facepile="true" 
		data-adapt-container-width="true" 
		style="z-index: 1000; top: 0; position: absolute; right: 0; margin: 100px 30px;">
	</div>
</div>
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/<?php _e( "en_US", "likemyfbpage" )?>/sdk.js#xfbml=1&version=v2.6";
